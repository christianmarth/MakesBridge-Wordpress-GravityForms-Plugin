            ...
            jQuery(document).ready(function(){
                ...
                jQuery('input[type="submit"]').click(function(){
                    ...
                    jQuery.post(ajaxUrl,{
                        ...
                        jQuery('#GF_Settings').append("<tr><td><a href=" + settId + " title='GF_Settings_Edit'>edit</a> | <a href=" +  " title='GF_Settings_Delete'>delete</a></td><td>" + formName + "</td><td>" + mksList + "</td></tr>")
                    });
                })
                                                                
                jQuery('#GF_Settings a[title="GF_Settings_Edit"]').click(function(e){
...
//                    console.log(settId)
                ...
                jQuery('#GF_Settings a[title="GF_Settings_Delete"]').click(function(e){
